...
def agregar_lista(lista):
    ...
    empresa = input("Ingrese la empresa del heroe: ")
    altura = validar_minimo(pedir_int("Ingrese la altura del heroe: "), 0)
    peso = validar_minimo(pedir_int("Ingrese el peso del heroe: "), 0)
    genero = input("Ingrese el genero del heroe: ")
    color_ojos = input("Ingrese el color de ojos del heroe: ")
    color_pelo = input("Ingrese el color de pelo del heroe: ")
    fuerza = validar_minimo(pedir_int("Ingrese la fuerza: "), 0)
    inteligencia = input("Ingrese la inteligencia del heroe: ")
